...
<h4 style="color: rgba(0,0,0,0.7);">&nbsp;&nbsp;The List<i class="material-icons">list</i> </h4>
<!-- content-->
   ...
   <div class="row">
      	...
      	<?php 
      		...
      		$db->connect();
      		$uid = $_SESSION['uid'];
      		$query = "SELECT * FROM bucket WHERE secur=0 ORDER BY timestmp DESC";
        ...
        <div class="grid-example col s12 m6 l4">
		  <div class="card">
		    ...
		    <div class="card-content-das">
		      <span class="card-title activator grey-text text-darken-4 center-align"><b><?php echo $row['title'] ?></b><i class="material-icons right">more_vert</i></span>
<?php
          require_once "process/function.php";
          $usrid = $row['user_id'];
          $usrname = unmfrmuid($usrid)
?>
		      <p>
          &nbsp;&nbsp;&nbsp;&nbsp;by:- <?php echo $usrname."<br>"; ?>
